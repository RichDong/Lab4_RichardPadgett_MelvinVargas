        ...
        try {
            while (!opcion.equals("g")) {
                ...
                if (opcion.equals("a")) {
                    ...
                    while (ataque > 50.0) {
                        System.out.println("El ataque no puede ser mayor que 50");
                    ...
                    while (salud < 100.0 || salud > 200.0) {
                        System.out.println("La salud no puede ser menor que 100.0 ni mayor que 200.0");
                    ...
                    while (costo > 300) {
                        System.out.println("El costo no puede ser mayor de 300");
            ...
            System.out.println("vuelva a intetar");
        }
    }
}
